                ...
                <div>
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            <label for="" class="px-1 text-xs font-semibold">First name</label>
                            <div class="flex">
                                <div
                                    class="z-10 flex items-center justify-center w-10 pl-1 text-center pointer-events-none">
                                    <i class="text-lg text-gray-400 mdi mdi-account-outline"></i></div>
                        ...
                        <div class="w-1/2 px-3 mb-5">
                            <label for="" class="px-1 text-xs font-semibold">Last name</label>
                            <div class="flex">
                                <div
                                    class="z-10 flex items-center justify-center w-10 pl-1 text-center pointer-events-none">
                                    <i class="text-lg text-gray-400 mdi mdi-account-outline"></i></div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div
                                    class="z-10 flex items-center justify-center w-10 pl-1 text-center pointer-events-none">
                                    <i class="text-lg text-gray-400 mdi mdi-email-outline"></i></div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                <div
                                    class="z-10 flex items-center justify-center w-10 pl-1 text-center pointer-events-none">
                                    <i class="text-lg text-gray-400 mdi mdi-lock-outline"></i></div>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-8">
                            <label for="" class="px-1 text-xs font-semibold"><b>repeat password</b></label>
                            <div class="flex">
                                <div
                                    class="z-10 flex items-center justify-center w-10 pl-1 text-center pointer-events-none">
                                    <i class="text-lg text-gray-400 mdi mdi-lock-outline"></i></div>

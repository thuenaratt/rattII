<template>
    <div>
        <div class="flex flex-col items-center py-4 bg-white border-b sm:flex-row sm:px-10 lg:px-20 xl:px-32">
            <a href="#" class="text-2xl font-bold text-gray-800">N & R Beauty</a>
                ...
                <form class="grid gap-6 mt-5">
                    <div class="relative">
                        ...
                        <label
                            ...
                            for="radio_1">
                            <img class="object-contain w-14" src="" alt="" />
                            <div class="ml-5">
                    ...
                    <div class="relative">
                        ...
                        <label
                            ...
                            <img class="object-contain w-14" src="" alt="" />
                            <div class="ml-5">
                                <span class="mt-2 font-semibold">Click & Collect</span>
                                <!-- <p class="text-sm leading-6 text-slate-500">Delivery: 2-4 Days</p> -->
                            </div>
                        </label>
                    </div>
                ...
                <div class="">
                    ...
                    <div class="relative">
                        <input type="text" id="card-holder" name="card-holder"
                            class="w-full px-4 py-3 text-sm uppercase border border-gray-200 rounded-md shadow-sm outline-none pl-11 focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                            placeholder="Your full name here" />
                        <div class="absolute inset-y-0 left-0 inline-flex items-center px-2 pointer-events-none">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-gray-400" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round"
